...
using Git.Storage.DataAccess.ZaiLiuKa;
...
using Git.Storage.IDataAccess.ZaiLiuKa;
using System;
...
namespace Git.Storage.Provider
{
    public partial class DataFactory
    {
        ...
        /************************************ ZaiLiuKa 命名空间 *************************************/
        public IZailiukaInfo ZailiukaInfo { get { return new ZailiukaInfoDataAccess(); } }

        public IQualification Qualification { get { return new QualificationDataAccess(); } }

        public IMotivation Motivation { get { return new MotivationDataAccess(); } }
