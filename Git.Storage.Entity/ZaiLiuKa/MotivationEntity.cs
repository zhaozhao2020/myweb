...
{
    [TableAttribute(DbName = "JooWMS", Name = "Motivation", IsInternal = false)]
    public partial class MotivationEntity : BaseEntity
    {
        ...
        public MotivationEntity IncludeZaiLiuKaNo(bool flag)
        {
        ...
        [DataMapping(ColumnName = "Type", DbType = DbType.StringFixedLength, Length = 6, CanNull = false, DefaultValue = null, AutoIncrement = false, IsMap = true)]
        public string Type { get; set; }

        public MotivationEntity IncludeType(bool flag)
        {
        ...
        public MotivationEntity IncludeUpdateTime(bool flag)
        {
        ...
        public MotivationEntity IncludeMemo(bool flag)
        {
        ...
        public MotivationEntity IncludeFlg(bool flag)
        {
